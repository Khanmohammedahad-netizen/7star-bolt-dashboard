...
import { PaymentType, PaymentStatus } from '../types/database';
...
export function AddPaymentModal({ eventId, onClose, onSuccess }: AddPaymentModalProps) {
  const [loading, setLoading] = useState(false);
  const [formData, setFormData] = useState({
    client_name: '',
    amount: '',
    payment_type: 'received' as PaymentType,
